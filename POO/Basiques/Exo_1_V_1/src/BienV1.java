public class BienV1 {
    ...
    public BienV1(int id, String reference, String adresse) {
        this.id = id;
    ...
    public BienV1(int id, String reference, double prix, String description, double superficie, String adresse) {
        this.id = id;
        this.reference = reference;
        this.prix = prix;
    ...
    public void copy(BienV1 newBien) {
        this.id = newBien.id;
